          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <span class="input-group-btn">
                <button type="button" class="glyphicon glyphicon-camera btn btn-warning" style="font-size:15px"><input title=" " type="file" name="file" id="file" value="<?php echo htmlspecialchars( $pet["photo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required style="position: absolute; left: 0; top: 0; opacity: 0;" /></button>
              </span>
