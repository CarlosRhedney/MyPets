							...
							<div class="col-md-12">
								<div class="woocommerce-billing-fields">
									...
									<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
										...
										<input type="text" value="<?php echo htmlspecialchars( $address["address"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Logradouro" id="billing_address_1" name="address" class="input-text ">
									</p>
                                    ...
                                    <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
										...
										<input type="text" placeholder="Número" id="billing_address_1" name="number" class="input-text ">
									</p>
